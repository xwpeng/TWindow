...
import com.android.twindow.imageloader.ImageAdapter;
...
public class ImageLoaderActivity extends AppCompatActivity implements AbsListView.OnScrollListener {
    ...
    private void initData() {
        String[] imageUrls = {
                ...
                "http://p3.gexing.com/G1/M00/26/96/rBACFFLC5gTjuIhnAAOL90rEeJg921.jpg",
                "http://pic35.photophoto.cn/20150402/0008020240882595_b.jpg",
                "http://img3.3lian.com/2013/c1/34/d/93.jpg",
                "http://b.zol-img.com.cn/desk/bizhi/image/3/960x600/1375841395686.jpg",
                "http://pic.qiantucdn.com/58pic/17/92/13/58PIC4b58PICfX3_1024.jpg",
                ...
                "http://pic.qiantucdn.com/58pic/26/24/60/69u58PICY9q_1024.jpg",
                ...
                "http://img.zcool.cn/community/01396459410b96a8012193a396e187.jpg@1280w_1l_2o_100sh.png"
        };
    ...
    private void initView() {
        ...
        mImageAdapter = new ImageAdapter(this, mUrList);
        ...
        if (!MyUtils.isWifi(this)) {
            ...
            builder.setPositiveButton("是", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    mImageAdapter.setCanGetBitmapFromNetWork(true);
